                                ...
                                <form class="form form-horizontal">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="number" id="jumlah_peserta" class="form-control" name="jumlah_peserta" placeholder="Jumlah Peserta" min="0" value="{{ $booking->jumlah_peserta }}" readonly
                                            ...
                                            <div class="col-md-10 form-group">
                                                @if ($booking->status == \App\Booking::STATUS_TUNGGU)
                                                    <span class="badge bg-light-secondary">
                                                        <i class="bi bi-question-circle me-50"></i> Tunggu
                                                    </span>
                                                @elseif ($booking->status == \App\Booking::STATUS_SETUJU)
                                                    <span class="badge bg-light-success">
                                                        <i class="bi bi-check-circle me-50"></i> Setuju
                                                    </span>
                                                @elseif ($booking->status == \App\Booking::STATUS_BATAL)
