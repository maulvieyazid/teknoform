                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('majalah.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="judul" class="form-control" name="judul"
                                                    placeholder="Judul Majalah" required autofocus>
                                            </div>
                                            ...
                                            <div class="col-5">
                                                <img id="image_preview" src="{{ asset('images/faces/2.jpg') }}"
                                                    width="200" height="200" style="display: none">
                                            </div>

                                            <div class="col-md-2">
                                                <label>Upload Majalah</label>
