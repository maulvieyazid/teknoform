                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('merchandise.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="nama_merchandise" class="form-control"
                                                    name="nama_merchandise" placeholder="Nama Merchandise" required
                                                    autofocus>
                                            </div>
                                            <div class="col-md-2">
                                                <label>Kode</label>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <input type="text" id="ukuran" class="form-control" name="ukuran"
                                                    placeholder="Ukuran Merchandise">
                                            </div>
                                            <div class="col-md-2">
